...
// create a component
const MachineriesDetails = ({ navigation, route }) => {
        ...
        <View style={{ flex: 1 }}>
            ...
            >
                ...
                <View style={{ width: '100%', flex: 1, backgroundColor: 'white', borderTopLeftRadius: 20, borderTopRightRadius: 20, paddingHorizontal: 20 }}>
                    ...
                    <View>
                        <Text style={{ fontSize: 20, fontWeight: 'bold', color: 'green' }}>{price} </Text>
                    </View> 
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            <Text style={{ fontSize: 18, fontWeight: 'bold', color: 'black', marginRight: 20 }}>Rating </Text>
...
export default MachineriesDetails;
